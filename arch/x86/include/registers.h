...
#define CRT_HORIZONTAL_TOTAL            0x01    // Horizontal Total Register
...
#define KEYBOARD_DATA_REGISTER          0x60    // Keyboard Data Register
#define KEYBOARD_COMMAND_REGISTER       0x64    // Keyboard Command Register
